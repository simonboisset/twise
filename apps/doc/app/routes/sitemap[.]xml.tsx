...
export const loader = async () => {
      ...
      for (const key in docs) {
        ...
        if (versionUrl === LATEST_VERSION) {
          if (lang === DEFAULT_LANGUAGE) {
            docsUrls.push(`
              <url>
                <loc>https://@twise/i18n.vercel.app/docs/${slug}</loc>
            ...
            docsUrls.push(`
              <url>
              <loc>https://@twise/i18n.vercel.app/${lang}/docs/${slug}</loc>
              <lastmod>${currentDateFormated}</lastmod>
              <changefreq>monthly</changefreq>
              <priority>0.7</priority>
            </url>
          ...
          if (lang === DEFAULT_LANGUAGE) {
            docsUrls.push(`
              <url>
                <loc>https://@twise/i18n.vercel.app/docs/v/${versionUrl}/${slug}</loc>
                <lastmod>${currentDateFormated}</lastmod>
                <changefreq>monthly</changefreq>
                <priority>0.7</priority>
              </url>
            ...
            docsUrls.push(`
              <url>
              <loc>https://@twise/i18n.vercel.app/${lang}/docs/v/${versionUrl}/${slug}</loc>
              <lastmod>${currentDateFormated}</lastmod>
              <changefreq>monthly</changefreq>
              <priority>0.7</priority>
            </url>
    ...
    .map(lang => {
      ...
      if (lang === DEFAULT_LANGUAGE) {
        return allArticles[DEFAULT_LANGUAGE].map(article => {
          return `
          <url>
            <loc>https://@twise/i18n.vercel.app/blog/${article.slug}</loc>
            <lastmod>${currentDateFormated}</lastmod>
            <changefreq>monthly</changefreq>
            <priority>0.7</priority>
          </url>
      ...
      return allArticles[safeLang].map(article => {
        return `
        <url>
          <loc>https://@twise/i18n.vercel.app/${lang}/blog/${article.slug}</loc>
          <lastmod>${currentDateFormated}</lastmod>
          <changefreq>monthly</changefreq>
          <priority>0.7</priority>
        </url>
  ...
  const content = `
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
      <url>
        <loc>https://@twise/i18n.vercel.app</loc>
        <lastmod>${currentDateFormated}</lastmod>
        <changefreq>monthly</changefreq>
        <priority>1</priority>
      </url>
      <url>
        <loc>https://@twise/i18n.vercel.app/fr</loc>
        <lastmod>${currentDateFormated}</lastmod>
        <changefreq>monthly</changefreq>
        <priority>1</priority>
      </url>
