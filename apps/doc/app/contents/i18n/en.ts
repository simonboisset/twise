import {InferTranslation, plural} from '@twise/i18n';

export const en = {
  landingPage: {
    title: 'Welcome to @twise/i18n',
    ...
    screenshotSection: {
      ...
      description:
        '@twise/i18n provides a type-safe approach to internationalization. Experience robust auto-completion and catch errors when variables change in your locales.',
      getStarted: 'Get Started',
    },
    footer: {
