...
export const fr: Translations = {
  landingPage: {
    title: 'Bienvenue sur @twise/i18n',
    subtitle:
    ...
    screenshotSection: {
      ...
      description:
        "@twise/i18n offre une approche type-safe pour l'internationalisation. Profitez d'une auto-complétion robuste et détectez les erreurs lorsque les variables changent dans vos locales.",
      getStarted: 'Commencer',
    },
    footer: {
